...
namespace Orbis
{
    ...
    public class Orbis : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(fontDebug, "Civs:   Tick:" + simulator.CurrentTick, new Vector2(10, 25), Color.Red);
            for (int i = 0; i < scene.Civilizations.Count; i++)
            {
                ...
                spriteBatch.DrawString(fontDebug, "Population= " + scene.Civilizations[i].Population, new Vector2(300, (i + 1) * 25 + 25), Color.Red);
                spriteBatch.DrawString(fontDebug, "Size= " + scene.Civilizations[i].Territory.Count, new Vector2(550, (i + 1) * 25 + 25), Color.Red);
            }
